...
def main():
    ...
    parallel = aec_to_parallel(gridworld.env())
    print(parallel.action_space)
    # print(parallel.num_agents)
    print(parallel.reset())
    # print(parallel.step(np.zeros(shape=(4),dtype=np.uint8)))
    parallel2 = parallel_wrapper_fn(gridworld.env())()
    print(parallel2.action_space)
