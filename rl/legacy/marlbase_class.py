...
class BaseAlgorithm(ABC):
    ...
    def _setup_learn(
        ...
        if self.ep_info_buffer is None or reset_num_timesteps:
            ...
            for i in range(4):
                self.ep_info_buffer.append(deque(maxlen=self._stats_window_size))
                self.ep_success_buffer.append(deque(maxlen=self._stats_window_size))
    ...
    def set_parameters(
        ...
        for name in params:
            ...
            if isinstance(attr, th.optim.Optimizer):
                ...
                print(type(params[name]),print(len(params[name])))
    ...
    def get_parameters(self,agent_index=None) -> dict[str, dict]:
        """
        ...
        for name in state_dicts_names:
            ...
            try:
                ...
                params[name] = attr[agent_index].state_dict()
        return params
    ...
    def save(
        ...
        for i in range(self.n_agent):
            params_to_save = self.get_parameters(i)

            save_to_zip_file(path+f"agent{i}", data=data, params=params_to_save, pytorch_variables=pytorch_variables)
