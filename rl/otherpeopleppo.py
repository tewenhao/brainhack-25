...
from otherpeoplespolicies import ActorCriticCnnPolicy, ActorCriticPolicy, BasePolicy, MultiInputActorCriticPolicy
...
class PPO(OnPolicyAlgorithm):
    ...
    def train(self) -> None:
        ...
        # self.logger.record("train/mean_reward", self.cum_reward)
