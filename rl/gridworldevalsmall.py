...
class raw_env(AECEnv[AgentID, ObsType, ActionType]):
    ...
    def reset(self, seed=None, options=None):
        ...
        self.num_moves = 0
        self.agent_distance_to_scout = {agent:0 for agent in self.agents}
        if self.render_mode in self.metadata["render_modes"]:
            self.render()
    ...
    def step(self, action: ActionType):
        ...
        # print(agent,action,self.rewards,end = " ")
        ...
        # print(self.agent_selection,action,self.actions)
